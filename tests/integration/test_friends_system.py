...
class TestFriendsPage:
    ...
    def test_friends_page_loads(self, mock_current_user, mock_get_user, client):
...
class TestFriendSearch:
    ...
    @patch('flask_login.current_user')
    def test_friend_search_valid_query(self, mock_current_user, client):
    ...
    @patch('flask_login.current_user')
    def test_friend_search_short_query(self, mock_current_user, client):
    ...
    @patch('flask_login.current_user')
    def test_friend_search_empty_query(self, mock_current_user, client):
...
class TestFriendRequests:
    ...
    @patch('flask_login.current_user')
    def test_send_friend_request_success(self, mock_current_user, client):
    ...
    @patch('flask_login.current_user')
    def test_send_friend_request_to_self(self, mock_current_user, client):
    ...
    @patch('flask_login.current_user')
    def test_send_friend_request_invalid_recipient(self, mock_current_user, client):
    ...
    @patch('flask_login.current_user')
    def test_accept_friend_request_success(self, mock_current_user, client):
    ...
    @patch('flask_login.current_user')
    def test_decline_friend_request_success(self, mock_current_user, client):
...
class TestFriendManagement:
    ...
    @patch('flask_login.current_user')
    def test_remove_friend_success(self, mock_current_user, client):
    ...
    @patch('flask_login.current_user')
    def test_get_friends_api_with_pagination(self, mock_current_user, client):
    ...
    @patch('flask_login.current_user')
    def test_get_friends_api_invalid_pagination(self, mock_current_user, client):
...
class TestFriendDeckViewing:
    ...
    @patch('flask_login.current_user')
    def test_view_friend_decks_authorized(self, mock_current_user, client):
    ...
    @patch('flask_login.current_user')
    def test_view_friend_decks_unauthorized(self, mock_current_user, client):
...
class TestFriendsErrorHandling:
    ...
    @patch('flask_login.current_user')
    def test_friend_request_database_error(self, mock_current_user, client):
    ...
    @patch('flask_login.current_user')
    def test_get_friends_api_database_error(self, mock_current_user, client):
...
class TestFriendTransactionIntegrity:
    ...
    @patch('flask_login.current_user')
    def test_accept_request_transaction_rollback(self, mock_current_user, client):
